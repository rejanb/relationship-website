...
<html lang="en">
  <head>
    ...
    <title>Kontakt | Relasjonsoverblikk</title>
  ...
  <body>
          ...
          <div class="row">
            <div class="col-12">
              <div class="breadcrum-text">
                  <div>
                    <h2 class="white">Kontakt Steven Balmbra</h2>
                  </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Kontakt Steven Balmbra</li>
              </ol>
            </nav>
          </div>
        </div>
    ...
    <section class="pricing py-5">
      <div class="container">
        <div class="row">
          ...
          Vær med på kontaktlisten til <strong>Relasjonsoverblikk</strong> og vi vil holde deg oppdatert med nyheter og utviklinger.  Vi er ikke annonse-basert, og vi deler ikke kontaktinformasjon.
    ...
    <section class="form-icon " style="padding-top:30px ;">
        <section class="contact-info-area">
            ...
            <h5>Adressen</h5>
            <h6>Bodinveien 56, 8010 Bodø, Norge</h6>
            </div>
            </div>
                     ...
                     <div class="col-12 col-lg-5">
                        <div class="contact-content mb-100">
                            ...
                            <div class="section-heading">
                                 <p class="small-header">KONTAKT OSS</p>
                                <h2><span>Ta gjerne kontakt med oss</h2>
                              </div>

                             <div class="contact-form-area">
                                  <form class="contact_form" action="{{route('no.contact.email')}}" method="POST">
                                    @csrf
                                  <div class="row">
                                      <div class="col-lg-12">
                                     ...
                                     <div class="col-12">
                                     <textarea style="height: 70px;" name="message" class="form-control" cols="30" rows="10" placeholder="Skirv her" required></textarea>
                                     </div>

                                     <div class="col-12">
                                      <button id="contact"  class="btn button">SENDE MELDING</button>
                                    </div>
                                 </div>
                                 </form>
                             </div>
